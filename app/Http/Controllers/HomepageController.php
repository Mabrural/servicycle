...
//         'workshop_id' => 'required|exists:workshops,id',
//         'vehicle_id' => 'required|exists:vehicles,id',
//         'booking_date' => 'required|date_format:d-m-Y H:i',
//         'notes' => 'nullable|string|max:500',
//     ]);
...
//         // Format tanggal dari d-m-Y H:i ke Y-m-d H:i:s
//         $bookingDate = \Carbon\Carbon::createFromFormat('d-m-Y H:i', $validated['booking_date'])
//             ->format('Y-m-d H:i:s');
