      ...
      <div class="auth-container">
        <div class="auth-card">
          <div class="auth-header">
            <div class="auth-logo">
              <img src="{{ asset('img/favicon/favicon.ico') }}" alt="ServiCycle Logo">
              <span class="auth-logo-text">ServiCycle</span>
            </div>
          ...
          <div class="auth-body">
            <form id="roleForm" action="{{ route('dashboard') }}" method="GET">
              @csrf
              <div class="role-selection">
                <label class="role-option" for="role_customer">
                  <input class="role-input" type="radio" name="role" id="role_customer" value="customer" required>
                  <div class="role-icon">
                ...
                <label class="role-option" for="role_workshop">
                  <input class="role-input" type="radio" name="role" id="role_workshop" value="workshop">
                  <div class="role-icon">
                    <i class="fas fa-tools"></i>
                  </div>
                  <h3 class="role-title">Bengkel</h3>
                  <p class="role-desc">Saya pemilik atau karyawan bengkel yang ingin mengelola layanan servis</p>
                </label>
              </div>
