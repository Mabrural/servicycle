            ...
            <div
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Update terakhir: <span
                                id="updatedAt">{{ $bookingService->updated_at ? $bookingService->updated_at->format('d M Y H:i') : '-' }}</span>
                        </p>
                    </div>
                ...
                <div class="space-y-4">
                    @php
                        ...
                        $cancelledTimeline = [
                            ...
                            'dibatalkan' => ['icon' => 'ban', 'color' => 'gray', 'label' => 'Dibatalkan'],
                        ];
                    ...
                    @foreach ($timeline as $status => $info)
                        @php
                            ...
                            // Logika untuk timeline normal (bukan ditolak / dibatalkan)
                            if (!in_array($currentStatus, ['ditolak', 'dibatalkan'])) {
                            ...
                            elseif ($currentStatus === 'ditolak') {
                                $isCompleted = in_array($status, ['menunggu_konfirmasi', 'ditolak']);
                            }
                            // Logika untuk timeline dibatalkan
                            elseif ($currentStatus === 'dibatalkan') {
                                $isCompleted = in_array($status, ['menunggu_konfirmasi', 'dibatalkan']);
                            }
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <p
                                    class="text-sm font-medium text-gray-900 @if (!$isCompleted && !$isActive) text-gray-400 @endif">
                                    {{ $info['label'] }}
                                </p>
