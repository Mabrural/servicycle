...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="#" class="btn btn-primary btn-sm d-flex align-items-center shadow-sm">
            ...
            <div class="col-md-4 mb-4 vehicle-card" data-name="suzuki bp6042gq">
                <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                    <div class="position-relative">
                        <img src="https://i.ibb.co/XYQk2YH/satria-f150.jpg"
                             class="card-img-top" alt="Suzuki All New Satria F150"
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto d-flex justify-content-between align-items-center">
                            <a href="#" class="btn btn-outline-primary btn-sm w-100 me-2">
                                <i class="bi bi-cpu"></i> Diagnosis
                            </a>
                        </div>
                    </div>
                </div>
