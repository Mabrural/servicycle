...
@section('container')
    <div class="container-xxl flex-grow-1 container-p-y animate__animated animate__fadeIn">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Isi data pengguna baru dengan lengkap dan benar.</p>
            </div>
                        ...
                        <div class="col-md-6 mb-3 position-relative">
                            ...
                            <div class="position-relative">
                                <input type="password" name="password"
                                    ...
                                    placeholder="Masukkan kata sandi" required id="passwordField">
                        ...
                        <div class="col-md-6 mb-3 position-relative">
                            ...
                            <div class="position-relative">
                                <input type="password" name="password_confirmation"
                                    ...
                                    placeholder="Ulangi kata sandi" required id="confirmPasswordField">
    ...
    {{-- Script kecil untuk toggle password visibility --}}
    @push('scripts')
        <script>
