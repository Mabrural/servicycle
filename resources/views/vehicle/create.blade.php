...
<head>
    ...
    <title>ServiCycle - Tambah Kendaraan</title>
...
<body class="bg-gray-50">
                ...
                <div class="form-section text-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                    <div class="flex items-start sm:items-center mobile-stack sm:flex-row">
                        ...
                        <div class="mobile-text-center sm:text-left flex-1">
                            <h1 class="text-2xl sm:text-3xl font-bold mb-2">Tambah Kendaraan Baru</h1>
                            <p class="text-white/90 text-sm sm:text-base">Daftarkan kendaraan Anda untuk memudahkan servis dan perawatan</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/10 rounded-lg p-3 sm:p-4 mt-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm">Pastikan data kendaraan yang Anda masukkan sudah benar dan lengkap untuk memudahkan proses servis.</p>
                            </div>
                        </div>
                    </div>
                </div>

                <form id="vehicleForm" class="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8" action="{{ route('vehicles.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    <!-- Progress Steps -->
                        ...
                        <div class="space-y-4 sm:space-y-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="engine_capacity" id="engine_capacity" value="{{ old('engine_capacity') }}" required
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300 mobile-form-input"
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 sm:p-8 text-center">
                                    ...
                                    <p class="text-sm text-gray-600 mb-4">Upload foto kendaraan untuk memudahkan identifikasi</p>
                            ...
                            <div>
                                ...
                                <textarea name="notes" id="notes" rows="4"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300 mobile-form-input"
                                    placeholder="Tambahkan catatan tambahan tentang kendaraan Anda...">{{ old('notes') }}</textarea>
    ...
    <script>
        ...
        function submitForm() {
            ...
            submitBtn.innerHTML = '<div class="loading-spinner mr-2"></div> Menyimpan...';
